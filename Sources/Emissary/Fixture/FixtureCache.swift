...
extension FixtureCache {
	static func fixtures<API: Emissary.API>(for url: URL) throws -> [Fixture<API>] {
	...
	static func response<API: Emissary.API, Resource>(for fixture: Fixture<API>, from url: URL, using transform: @escaping (Data) throws -> Resource) throws -> Result<Resource, NetworkError<API.Error>> {
