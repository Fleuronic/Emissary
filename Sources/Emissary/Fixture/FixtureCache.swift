...
actor FixtureCache {
	...
	static private let shared = FixtureCache()
...
private extension FixtureCache {
	...
	func set<API: Emissary.API, Response>(_ response: Result<Response, NetworkError<API.Error>>, for name: String, using apiType: API.Type) {
